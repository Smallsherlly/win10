...
int publicNode(Node* head1,Node* head2)
{
	Node* node = head2;
	for(;head1->data!=head2->data;head1=head1->next)
	{
		for(head2=node;head1->data!=head2->data;head2=head2->next)
		{
			if(head2->next==NULL)
			{
				break;
