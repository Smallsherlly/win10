...
# 2 "push.c" 2
# 1 "/home/ubuntu/public/get_direction.h" 1
...
# 24 "/usr/include/i386-linux-gnu/bits/termios.h" 3 4
...
# 108 "/usr/include/termios.h" 3 4

# 5 "/home/ubuntu/public/get_direction.h" 2
...
# 6 "/home/ubuntu/public/get_direction.h" 2
...
# 7 "/home/ubuntu/public/get_direction.h" 2
...
static int get_direction(void)
{
 ...
 new.c_lflag &= ~(0000002|0000010);

 ret= tcsetattr(0,0,&new);
 if(0 > ret)
 {
  perror("tcsetattr");
  return -2;
